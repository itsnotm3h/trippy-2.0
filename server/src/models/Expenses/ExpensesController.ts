...
export const deleteExpenses = async (req: AuthRequest, res: Response) => {
  try {
    const deleteExpense = ExpenseDeleteSchema.parse({
    ...
    const result = await ExpensesService.deleteExpense(deleteExpense);
